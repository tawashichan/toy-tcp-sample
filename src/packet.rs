...
use pnet::packet::{Packet, ip::IpNextHeaderProtocols::{self, Tcf}, tcp::TcpPacket, util};

use crate::tcpflags;

// first 20 bytes are tcp header  
...
impl TCPPacket {
    ...
    pub fn get_seq(&self) -> u32 {
        // transform big endian byes to native endian
        u32::from_be_bytes(
